...
def parse(path: Path):
    ...
    # A run of consecutive plain lines is one paragraph; a blank line ends it.
    # Paragraphs before the first "##" belong to the page, after it to the
    # section. Prose used to be dropped on the floor here, which silently ate
    # the intros written for 0.19.2 and 0.19.3.
    para = []
...
/* Prose above a section's bullets: the lore opening, the release summary. */
.lead {
